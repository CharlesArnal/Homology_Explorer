...
param_file = os.path.join(my_local_path, "Parameters_files","param_exp_4_bis_RL_random_small_network_triangs.txt")

exp_name = "exp_4_bis_RL_random_small_network_triangs"
...
# [["3", "128", "128", "32", "0.001", "1000", "False", "0"]]
...
#               "optimizer_parameters": [["3", "128", "128", "32", "0.01", "1000", "False", "0"], ["3", "128", "128", "32", "0.003", "1000", "False", "0"], ["3", "128", "128", "32", "0.001", "1000", "False", "0"], ["3", "128", "128", "32", "0.0003", "1000", "False", "0"], ["3", "128", "128", "32", "0.0001", "1000", "False", "0"]]
#             },
#             {"optimizer_type" : ["RL"], 
#               "num_seeds" : ["4"],
#               #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
...
#               "obj_function": [(f"homology_bt_Harnack.10_2_10", f"{66}"),(f"homology_bt_Harnack.20_2_20", f"{231}")],
#               "max_running_time": [f"{3600*10}"],
#               "optimizer_parameters": [["3", "128", "128", "32", "0.001", "1000", "False", "0"], ["4", "256", "256", "128", "32", "0.001", "1000", "False", "0"], ["5", "256", "256", "256", "128", "32", "0.001", "1000", "False", "0"]]
#             },
#             {"optimizer_type" : ["RL"], 
#               "num_seeds" : ["4"],
#               #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
...
#               "obj_function": [(f"homology_bt_Harnack.10_2_10", f"{66}"),(f"homology_bt_Harnack.20_2_20", f"{231}")],
#               "max_running_time": [f"{3600*10}"],
#               "optimizer_parameters": [["5", "256", "256", "256", "128", "32", "0.001", "500", "False", "0"], ["5", "256", "256", "256", "128", "32", "0.001", "1000", "False", "0"], ["5", "256", "256", "256", "128", "32", "0.001", "2000", "False", "0"], ["5", "256", "256", "256", "128", "32", "0.001", "4000", "False", "0"]]
#             },
#             {"optimizer_type" : ["RL"], 
#               "num_seeds" : ["4"],
#               #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
...
#               "obj_function": [(f"homology_bt_Harnack.10_2_10", f"{66}"),(f"homology_bt_Harnack.20_2_20", f"{231}")],
#               "max_running_time": [f"{3600*10}"],
#               "optimizer_parameters": [["5", "256", "256", "256", "128", "32", "0.001", "1000", "False", "0"], ["5", "256", "256", "256", "128", "32", "0.001", "1000", "True", "0.1"], ["5", "256", "256", "256", "128", "32", "0.001", "1000", "True", "0.4"]]
#             },
#             {"optimizer_type" : ["RL"], 
#               "num_seeds" : ["5"],
#               #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
...
# # # Exp 3 bis size_pop_small_network
# param_grid = [{"optimizer_type" : ["RL"], 
#               "num_seeds" : ["4"],
#               #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
#               "obj_function": [(f"homology_bt_Harnack.10_2_10", f"{66}"),(f"homology_bt_Harnack.20_2_20", f"{231}")],
#               "max_running_time": [f"{3600*10}"],
#               "optimizer_parameters": [["3", "128", "128", "32", "0.001", "500", "False", "0"], ["3", "128", "128", "32", "0.001", "1000", "False", "0"], ["3", "128", "128", "32", "0.001", "2000", "False", "0"], ["3", "128", "128", "32", "0.001", "4000", "False", "0"]]
#             },
#             {"optimizer_type" : ["RL"], 
#               "num_seeds" : ["4"],
#               #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
...
#               "obj_function": [(f"homology_bt_Harnack.10_2_10", f"{66}"),(f"homology_bt_Harnack.20_2_20", f"{231}")],
#               "max_running_time": [f"{3600*10}"],
#               "optimizer_parameters": [["5", "256", "256", "256", "128", "32", "0.001", "500", "False", "0"], ["5", "256", "256", "256", "128", "32", "0.001", "500", "True", "0.5"], ["5", "256", "256", "256", "128", "32", "0.001", "500", "True", "0.1"]]
#             },
#             {"optimizer_type" : ["RL"], 
#               "num_seeds" : ["4"],
#               #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
...
# # # # Exp 4 bis random_small_network
param_grid = [{"optimizer_type" : ["RL"], 
              "num_seeds" : ["4"],
              #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
              "obj_function": [(f"homology_bt_Harnack.10_2_10", f"{66}"),(f"homology_bt_Harnack.20_2_20", f"{231}")],
              "max_running_time": [f"{3600*10}"],
              "optimizer_parameters": [["3", "128", "128", "32", "0.001", "500", "False", "0"], ["3", "128", "128", "32", "0.001", "500", "True", "0.5"], ["3", "128", "128", "32", "0.001", "500", "True", "0.1"]]
            },
            {"optimizer_type" : ["RL"], 
              "num_seeds" : ["4"],
              #"obj_function": [(f"graph_2.1_{N}", f"{int(N*(N-1)/2)}") for N in [9, 19, 29]] + [(f"graph_2.3_{N}", f"{int(N*(N-1)/2)}") for N in [20, 30, 40]] ,   # the second entry of each pair is the dimension (it is determined by the objective function)
